  ...
  <div class="gallery-header">
    ...
    <nav class="breadcrumbs">
      <div class="inner">
        <ul>
          ...
          <li class="breadcrumbs__item">
            <a href="<?php echo home_url('/FlorenceB'); ?>">florenceB</a>
          </li>
          <li class="breadcrumbs__item">
            <a href="<?php echo home_url('/FlorenceB_gallery'); ?>">Gallery</a>
          </li>
        </ul>
      </div>
    </nav>
    <div class="inner">
      <p class="gallery-header__lead">
        ...
        各扉、床材、サッシなどはこだわりの素材を使用しており、格調高い空間を演出してくれます。<br />
        室内は白を基調としており、フローリングとドアはナチュラルブラウンでまとめ、キッチンと浴室は深みのあるダークブラウンをアクセントに。<br />
        ウォークインクローゼットは、約2帖ほどの大容量タイプを採用しております。<br />全室約6mの広いべランダも付いております。<br />
